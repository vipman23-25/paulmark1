import { Users, Clock, Calendar, Bell, Timer, LogOut, LayoutDashboard, Activity, Settings, Umbrella } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Hatırlatıcılar', url: '/admin/reminders', icon: Bell },
...
export function AdminSidebar() {
  ...
  const handlePasswordChange = () => {
    ...
    const success = mockDb.changePassword(user?.id || '', pwdForm.currentPass, pwdForm.newPass);
    if (success) {
